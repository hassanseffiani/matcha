...
var Kd=[C.B,C.J],Ld=function(a){var b=a[C.Pd];b&&D(40);var c=a[C.Qd];c&&D(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Pd&&f!==C.Qd)if(-1<Ga(Kd,f)){var h=f,k=a[f],l=d[e];vd().set(h,k,l,"MA","MA-05",c)}else{}},Md=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
d,0))/h,1))*(1-Math.min((Math.max(0-e.top,0)+Math.max(e.bottom-c,0))/f,1)):0};var Yd=[],Zd=!(!G.IntersectionObserver||!G.IntersectionObserverEntry),ae=function(a,b,c){for(var d=new G.IntersectionObserver(a,{threshold:c}),e=0;e<b.length;e++)d.observe(b[e]);for(var f=0;f<Yd.length;f++)if(!Yd[f])return Yd[f]=d,f;return Yd.push(d)-1},be=function(a,b,c){function d(k,l){var n={top:0,bottom:0,right:0,left:0,width:0,height:0},q={boundingClientRect:k.getBoundingClientRect(),
intersectionRatio:l,intersectionRect:n,isIntersecting:0<l,rootBounds:n,target:k,time:Xa()};I(function(){return a(q)})}for(var e=[],f=[],h=0;h<b.length;h++)e.push(0),f.push(-1);c.sort(function(k,l){return k-l});return function(){for(var k=0;k<b.length;k++){var l=Xd(b[k]);if(l>e[k])for(;f[k]<c.length-1&&l>=c[f[k]+1];)d(b[k],l),f[k]++;else if(l<e[k])for(;0<=f[k]&&l<=c[f[k]];)d(b[k],l),f[k]--;e[k]=l}}},ce=function(a,b,c){for(var d=0;d<c.length;d++)1<c[d]?c[d]=1:0>c[d]&&(c[d]=0);if(Zd){var e=!1;I(function(){e||
be(a,b,c)()});return ae(function(f){e=!0;for(var h={kb:0};h.kb<f.length;h={kb:h.kb},h.kb++)I(function(k){return function(){return a(f[k.kb])}}(h))},b,c)}return G.setInterval(be(a,b,c),1E3)},de=function(a){Zd?0<=a&&a<Yd.length&&Yd[a]&&(Yd[a].disconnect(),Yd[a]=void 0):G.clearInterval(a)};var ee=/:[0-9]+$/,fe=function(a,b,c){for(var d=a.split("&"),e=0;e<d.length;e++){var f=d[e].split("=");if(decodeURIComponent(f[0]).replace(/\+/g," ")===b){var h=f.slice(1).join("=");return c?h:decodeURIComponent(h).replace(/\+/g," ")}}},ie=function(a,b,c,d,e){b&&(b=String(b).toLowerCase());if("protocol"===b||"port"===b)a.protocol=ge(a.protocol)||ge(G.location.protocol);"port"===b?a.port=String(Number(a.hostname?a.port:G.location.port)||("http"==a.protocol?80:"https"==a.protocol?443:"")):"host"===b&&
...
function sq(a,b){}var Z={g:{}};Z.g.ctv=["google"],function(){(function(a){Z.__ctv=a;Z.__ctv.h="ctv";Z.__ctv.i=!0;Z.__ctv.priorityOverride=0})(function(){return"36"})}();
...
Z.g.tl=["google"],function(){function a(b){return function(){if(b.yd&&b.zd>=b.yd)b.vd&&W("self").clearInterval(b.vd);else{b.zd++;var c=Um().getTime();Zm({event:b.M,"gtm.timerId":b.vd,"gtm.timerEventNumber":b.zd,"gtm.timerInterval":b.interval,"gtm.timerLimit":b.yd,"gtm.timerStartTime":b.rf,"gtm.timerCurrentTime":c,"gtm.timerElapsedTime":c-b.rf,"gtm.triggers":b.Ch})}}}(function(b){Z.__tl=b;Z.__tl.h="tl";Z.__tl.i=!0;Z.__tl.priorityOverride=0})(function(b){I(b.vtp_gtmOnSuccess);if(!isNaN(b.vtp_interval)){var c=
{M:b.vtp_eventName,zd:0,interval:Number(b.vtp_interval),yd:isNaN(b.vtp_limit)?0:Number(b.vtp_limit),Ch:String(b.vtp_uniqueTriggerId||"0"),rf:Um().getTime()};c.vd=W("self").setInterval(a(c),0>Number(b.vtp_interval)?0:Number(b.vtp_interval))}})}();
...
Z.g.ytl=["google"],function(){function a(){var t=Math.round(1E9*Math.random())+"";return H.getElementById(t)?a():t}function b(t,v){if(!t)return!1;for(var x=0;x<q.length;x++)if(0<=t.indexOf("//"+q[x]+"/"+v))return!0;return!1}function c(t,v){var x=t.getAttribute("src");if(b(x,"embed/")){if(0<x.indexOf("enablejsapi=1"))return!0;if(v){var z=t.setAttribute,w;var y=-1!==x.indexOf("?")?"&":"?";if(-1<x.indexOf("origin="))w=x+y+"enablejsapi=1";else{if(!r){var A=W("document");r=A.location.protocol+"//"+A.location.hostname;
A.location.port&&(r+=":"+A.location.port)}w=x+y+"enablejsapi=1&origin="+encodeURIComponent(r)}z.call(t,"src",w);return!0}}return!1}function d(t,v){if(!t.getAttribute("data-gtm-yt-inspected-"+v.Md)&&(t.setAttribute("data-gtm-yt-inspected-"+v.Md,"true"),c(t,v.$e))){t.id||(t.id=a());var x=W("YT"),z=x.get(t.id);z||(z=new x.Player(t.id));var w=f(z,v),y={},A;for(A in w)y.lb=A,w.hasOwnProperty(y.lb)&&z.addEventListener(y.lb,function(B){return function(F){return w[B.lb](F.data)}}(y)),y={lb:y.lb}}}function e(t){I(function(){function v(){for(var z=
x.getElementsByTagName("iframe"),w=z.length,y=0;y<w;y++)d(z[y],t)}var x=W("document");v();Dl(v)})}function f(t,v){var x,z;function w(){P=El(function(){return{url:K,title:T,Xe:Q,Lg:t.getCurrentTime(),playbackRate:V}},v.Md,t.getIframe());Q=0;T=K="";V=1;return y}function y(na){switch(na){case p.PLAYING:Q=Math.round(t.getDuration());K=t.getVideoUrl();if(t.getVideoData){var Y=t.getVideoData();T=Y?Y.title:""}V=t.getPlaybackRate();v.Gg?Zm(P.createEvent("start")):P.ld();ka=l(v.sh,v.rh,t.getDuration());return A(na);
default:return y}}function A(){la=t.getCurrentTime();R=Um().getTime();P.wh();N();return B}function B(na){var Y;switch(na){case p.ENDED:return E(na);case p.PAUSED:Y="pause";case p.BUFFERING:var Da=t.getCurrentTime()-la;Y=1<Math.abs((Um().getTime()-R)/1E3*V-Da)?"seek":Y||"buffering";t.getCurrentTime()&&(v.Fg?Zm(P.createEvent(Y)):P.ld());M();return F;case p.UNSTARTED:return w(na);default:return B}}function F(na){switch(na){case p.ENDED:return E(na);case p.PLAYING:return A(na);case p.UNSTARTED:return w(na);
default:return F}}function E(){for(;z;){var na=x;Sm(z);na()}v.Eg&&Zm(P.createEvent("complete",1));return w(p.UNSTARTED)}function J(){}function M(){z&&(Sm(z),z=0,x=J)}function N(){if(ka.length&&0!==V){var na=-1,Y;do{Y=ka[0];if(Y.Pa>t.getDuration())return;na=(Y.Pa-t.getCurrentTime())/V;if(0>na&&(ka.shift(),0===ka.length))return}while(0>na);x=function(){z=0;x=J;0<ka.length&&ka[0].Pa===Y.Pa&&(ka.shift(),Zm(P.createEvent("progress",Y.ff,Y.lf)));N()};z=Tm(x,1E3*na)}}var P,ka=[],Q,K,T,V,la,R,xa=w(p.UNSTARTED);
z=0;x=J;return{onStateChange:function(na){xa=xa(na)},onPlaybackRateChange:function(na){la=t.getCurrentTime();R=Um().getTime();P.ld();V=na;M();N()}}}function h(t){for(var v=t.split(","),x=v.length,z=[],w=0;w<x;w++){var y=parseInt(v[w],10);isNaN(y)||100<y||0>y||z.push(y/100)}z.sort(function(A,B){return A-B});return z}function k(t){for(var v=t.split(","),x=v.length,z=[],w=0;w<x;w++){var y=parseInt(v[w],10);isNaN(y)||0>y||z.push(y)}z.sort(function(A,B){return A-B});return z}function l(t,v,x){var z=t.map(function(A){return{Pa:A,
lf:A,ff:void 0}});if(!v.length)return z;var w=v.map(function(A){return{Pa:A*x,lf:void 0,ff:A}});if(!z.length)return w;var y=z.concat(w);y.sort(function(A,B){return A.Pa-B.Pa});return y}function n(t){var v=!!t.vtp_captureStart,x=!!t.vtp_captureComplete,z=!!t.vtp_capturePause,w=h(t.vtp_progressThresholdsPercent+""),y=k(t.vtp_progressThresholdsTimeInSeconds+""),A=!!t.vtp_fixMissingApi;if(v||x||z||w.length||y.length){var B={Gg:v,Eg:x,Fg:z,rh:w,sh:y,$e:A,Md:void 0===t.vtp_uniqueTriggerId?"":t.vtp_uniqueTriggerId},
F=W("YT"),E=function(){e(B)};I(t.vtp_gtmOnSuccess);if(F)F.ready&&F.ready(E);else{var J=W("onYouTubeIframeAPIReady");$m("onYouTubeIframeAPIReady",function(){J&&J();E()});I(function(){for(var M=W("document"),N=M.getElementsByTagName("script"),P=N.length,ka=0;ka<P;ka++){var Q=N[ka].getAttribute("src");if(b(Q,"iframe_api")||b(Q,"player_api"))return}for(var K=M.getElementsByTagName("iframe"),T=K.length,V=0;V<T;V++)if(!u&&c(K[V],B.$e)){O("https://www.youtube.com/iframe_api");u=!0;break}})}}else I(t.vtp_gtmOnSuccess)}
var q=["www.youtube.com","www.youtube-nocookie.com"],p={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},r,u=!1;(function(t){Z.__ytl=t;Z.__ytl.h="ytl";Z.__ytl.i=!0;Z.__ytl.priorityOverride=0})(function(t){t.vtp_triggerStartOption?n(t):Th(function(){n(t)})})}();
Z.g.opt=["google"],function(){var a;(function(b){Z.__opt=b;Z.__opt.h="opt";Z.__opt.i=!0;Z.__opt.priorityOverride=0})(function(b){var c={};if(b.vtp_gaSettings){var d=b.vtp_gaSettings;m(On(d.vtp_fieldsToSet,"fieldName","value"),c);b.vtp_gaSettings=null;d.vtp_fieldsToSet=void 0;var e=m(d);b=m(b,e)||{}}m(On(b.vtp_fieldsToSet,"fieldName","value"),c);var f=hi(b.vtp_functionName);if(Ca(f)){f.r=!0;var h="",k="";b.vtp_setTrackerName&&
"string"===typeof b.vtp_trackerName?""!==b.vtp_trackerName&&(k=b.vtp_trackerName,h=k+"."):(k="gtm"+Ue(),h=k+".");var l={name:!0,clientId:!0,sampleRate:!0,siteSpeedSampleRate:!0,alwaysSendReferrer:!0,allowAnchor:!0,allowLinker:!0,cookieName:!0,cookieDomain:!0,cookieExpires:!0,cookiePath:!0,cookieUpdate:!0,legacyCookieDomain:!0,legacyHistoryImport:!0,storage:!0,useAmpClientId:!0,storeGac:!0},n={allowAnchor:!0,allowLinker:!0,alwaysSendReferrer:!0,anonymizeIp:!0,cookieUpdate:!0,exFatal:!0,forceSSL:!0,
javaEnabled:!0,legacyHistoryImport:!0,nonInteraction:!0,useAmpClientId:!0,useBeacon:!0,storeGac:!0},q=function(x,z,w){var y=0,A;for(A in x)if(x.hasOwnProperty(A)&&(w&&l[A]||!w&&void 0===l[A])){var B=n[A]?Sa(x[A]):x[A];"anonymizeIp"!==A||B||(B=void 0);z[A]=B;y++}return y},p={name:k};q(c,p,!0);var r={"&gtm":uj(!0)};q(c,r,!1);var u=encodeURI(hh("https:","http:","//www.google-analytics.com/"+(b.vtp_useDebugVersion?"u/analytics_debug.js":"analytics.js"),!!c.forceSSL));f("create",b.vtp_trackingId,p);f(h+
"set",r);f(h+"require",b.vtp_optimizeContainerId,{dataLayer:"dataLayer"});f(b.vtp_gtmOnSuccess);f(h+"require","render");a||(a=!0,O(u,function(){return fi().loaded||b.vtp_gtmOnFailure()},b.vtp_gtmOnFailure));var t=W("dataLayer"),v=t&&t.hide;v&&(v.end||!0===v["GTM-T3L6RFK"])&&(v[b.vtp_optimizeContainerId]=!0)}else I(b.vtp_gtmOnFailure)})}();
...
Z.g.lcl=[],function(){function a(){var c=W("document"),d=0,e=function(f){var h=f.target;if(h&&3!==f.which&&!(f.ah||f.timeStamp&&f.timeStamp===d)){d=f.timeStamp;h=pd(h,["a","area"],100);if(!h)return f.returnValue;var k=f.defaultPrevented||!1===f.returnValue,l=Al("lcl",k?"nv.mwt":"mwt",0),n;n=k?Al("lcl","nv.ids",[]):Al("lcl","ids",[]);if(n.length){var q=wl(h,"gtm.linkClick",n);if(b(f,h,c)&&!k&&l&&h.href){var p=String(gn(h,"rel")||""),r=!!Ia(p.split(" "),function(v){return"noreferrer"===v.toLowerCase()});
r&&D(36);var u=W((gn(h,"target")||"_self").substring(1)),t=!0;if(Zm(q,tm(function(){var v;if(v=t&&u){var x;a:if(r){var z;try{z=new MouseEvent(f.type,{bubbles:!0})}catch(w){if(!c.createEvent){x=!1;break a}z=c.createEvent("MouseEvents");z.initEvent(f.type,!0,!0)}z.ah=!0;f.target.dispatchEvent(z);x=!0}else x=!1;v=!x}v&&(u.location.href=gn(h,"href"))}),l))t=!1;else return f.preventDefault&&f.preventDefault(),f.returnValue=!1}else Zm(q,function(){},l||2E3);return!0}}};kd(c,"click",e,!1);kd(c,"auxclick",
e,!1)}function b(c,d,e){if(2===c.which||c.ctrlKey||c.shiftKey||c.altKey||c.metaKey)return!1;var f=gn(d,"href"),h=f.indexOf("#"),k=gn(d,"target");if(k&&"_self"!==k&&"_parent"!==k&&"_top"!==k||0===h)return!1;if(0<h){var l=Xm(f),n=Xm(e.location);return l!==n}return!0}(function(c){Z.__lcl=c;Z.__lcl.h="lcl";Z.__lcl.i=!0;Z.__lcl.priorityOverride=0})(function(c){var d=void 0===c.vtp_waitForTags?!0:c.vtp_waitForTags,e=void 0===c.vtp_checkValidation?!0:c.vtp_checkValidation,f=Number(c.vtp_waitForTagsTimeout);
if(!f||0>=f)f=2E3;var h=c.vtp_uniqueTriggerId||"0";if(d){var k=function(n){return Math.max(f,n)};zl("lcl","mwt",k,0);e||zl("lcl","nv.mwt",k,0)}var l=function(n){n.push(h);return n};zl("lcl","ids",l,[]);e||zl("lcl","nv.ids",l,[]);dn("lcl")||(a(),en("lcl"));I(c.vtp_gtmOnSuccess)})}();
Z.g.evl=["google"],function(){function a(){var f=Number(Ym("gtm.start"))||0;return Um().getTime()-f}function b(f,h,k,l){function n(){if(!Vd(f.target)){h.has(d.ic)||h.set(d.ic,""+a());h.has(d.dd)||h.set(d.dd,""+a());var p=0;h.has(d.kc)&&(p=Number(h.get(d.kc)));p+=100;h.set(d.kc,""+p);if(p>=k){var r=wl(f.target,"gtm.elementVisibility",[h.m]),u=Xd(f.target);r["gtm.visibleRatio"]=Math.round(1E3*u)/10;r["gtm.visibleTime"]=k;r["gtm.visibleFirstTime"]=Number(h.get(d.dd));r["gtm.visibleLastTime"]=Number(h.get(d.ic));
Zm(r);l()}}}if(!h.has(d.Bb)&&(0==k&&n(),!h.has(d.cb))){var q=W("self").setInterval(n,100);h.set(d.Bb,q)}}function c(f){f.has(d.Bb)&&(W("self").clearInterval(Number(f.get(d.Bb))),f.o(d.Bb))}var d={Bb:"polling-id-",dd:"first-on-screen-",ic:"recent-on-screen-",kc:"total-visible-time-",cb:"has-fired-"},e=function(f,h){this.element=f;this.m=h};e.prototype.has=function(f){return!!this.element.getAttribute("data-gtm-vis-"+f+this.m)};e.prototype.get=function(f){return this.element.getAttribute("data-gtm-vis-"+
f+this.m)};e.prototype.set=function(f,h){this.element.setAttribute("data-gtm-vis-"+f+this.m,h)};e.prototype.o=function(f){this.element.removeAttribute("data-gtm-vis-"+f+this.m)};(function(f){Z.__evl=f;Z.__evl.h="evl";Z.__evl.i=!0;Z.__evl.priorityOverride=0})(function(f){function h(){var z=!1,w=null;if("CSS"===l){try{w=Rd(n)}catch(E){D(46)}z=!!w&&v.length!=w.length}else if("ID"===l){var y=H.getElementById(n);y&&(w=[y],z=1!=v.length||v[0]!==y)}w||(w=[],z=0<v.length);if(z){for(var A=0;A<v.length;A++){var B=
new e(v[A],u);c(B)}v=[];for(var F=0;F<w.length;F++)v.push(w[F]);0<=x&&de(x);0<v.length&&(x=ce(k,v,[r]))}}function k(z){var w=new e(z.target,u);z.intersectionRatio>=r?w.has(d.cb)||b(z,w,p,"ONCE"===t?function(){for(var y=0;y<v.length;y++){var A=new e(v[y],u);A.set(d.cb,"1");c(A)}de(x);if(q&&Cl)for(var B=0;B<Cl.length;B++)Cl[B]===h&&Cl.splice(B,1)}:function(){w.set(d.cb,"1");c(w)}):(c(w),"MANY_PER_ELEMENT"===t&&w.has(d.cb)&&(w.o(d.cb),w.o(d.kc)),w.o(d.ic))}var l=f.vtp_selectorType,n;"ID"===l?n=String(f.vtp_elementId):
"CSS"===l&&(n=String(f.vtp_elementSelector));var q=!!f.vtp_useDomChangeListener,p=f.vtp_useOnScreenDuration&&Number(f.vtp_onScreenDuration)||0,r=(Number(f.vtp_onScreenRatio)||50)/100,u=f.vtp_uniqueTriggerId,t=f.vtp_firingFrequency,v=[],x=-1;h();q&&Dl(h);I(f.vtp_gtmOnSuccess)})}();
